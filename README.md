...
A source-aware 3D organ explorer for the EASI Human Atlas desk. It ships 26 Human Reference Atlas organ models, a BodyParts3D stomach and full skeleton, plus a procedural skin cross section, names every structure inside each model, and pairs the 3D stage with descriptive terms, facts, guided lessons, and quizzes. English only.

Live: https://easi.pivotventures.tech/atlas/organs/ (the **Organs** tab of the Human Atlas desk in the EASI academics portal).

## What it does

- **29 organs across 11 systems**: heart and major blood vessels; brain and spinal cord; eye; lungs, larynx, trachea, and main bronchi; mouth with tongue, teeth, and salivary glands; stomach with oesophagus and duodenum; liver, gallbladder, pancreas, small and large intestine; spleen, thymus, lymph node, and palatine tonsil; kidney, renal pelvis and ureter, and bladder; prostate and seminal glands; the full 206-bone skeleton, bony pelvis, knee joint, and intervertebral discs; skin.
...
Source code is MIT licensed. 26 of the binary 3D models are Human Reference Atlas data and two (stomach, skeleton) are BodyParts3D data, all under CC BY 4.0; see [THIRD_PARTY_ASSETS.md](THIRD_PARTY_ASSETS.md) for provenance, the modification disclosure, and checksums. The skin cross section is generated by project code.
