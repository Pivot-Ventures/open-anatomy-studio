...
export const organs: Organ[] = [
  ...
  },
  {
    ...
    accent: "#d9483f",
    summary:
      "The whole-body tree of arteries, from the aorta leaving the heart down to the arteries of the fingers and toes. Every branch carries oxygenated blood away from the heart under high pressure.",
    role: "Delivers oxygen-rich blood from the heart to every tissue.",
    modelScope: "Named arteries of the BodyParts3D reference body, 639 parts. Capillaries and the smallest branches are not modelled.",
    facts: [
      { label: "Largest artery", value: "The aorta, about 2.5 cm across at the heart", sourceIds: ["openstax"], reviewStatus: "draft" },
      { label: "Wall", value: "Three layers with thick elastic and muscular tissue" },
      { label: "Pulse", value: "The pressure wave felt where an artery passes near the skin, such as the wrist and neck" },
      { label: "Exception", value: "The pulmonary arteries carry deoxygenated blood to the lungs" },
    ],
    functions: [
      "Carry blood away from the heart at high pressure",
      "Elastic walls smooth the pulse into steady flow",
      "Muscular walls widen or narrow to direct blood where it is needed",
    ],
    terms: [
      { term: "Aorta", meaning: "The main artery leaving the left ventricle; it arches then descends through chest and abdomen." },
      { term: "Carotid", meaning: "The neck arteries that supply the head and brain." },
      { term: "Subclavian", meaning: "The artery under the collarbone that supplies the arm." },
      { term: "Iliac", meaning: "The arteries that carry blood from the abdominal aorta into the pelvis and legs." },
      { term: "Femoral", meaning: "The main artery of the thigh." },
      { term: "Coronary", meaning: "The arteries on the heart's surface that feed the heart muscle." },
      { term: "Pulse", meaning: "The rhythmic expansion of an artery with each heartbeat." },
    ],
    hotspots: [
      { id: "arch", name: "Arch of aorta", detail: "The curve above the heart that gives off the arteries to the head and arms.", mesh: "BP3D_Arch_of_aorta" },
      { id: "carotid", name: "Common carotid artery", detail: "Runs up the neck to supply the brain and face.", mesh: "BP3D_common_carotid_artery_L" },
      { id: "abdominal", name: "Abdominal aorta", detail: "Supplies the digestive organs and kidneys before splitting into the iliac arteries.", mesh: "BP3D_Abdominal_aorta" },
      { id: "femoral", name: "Femoral artery", detail: "The main artery of the thigh, felt in the groin.", mesh: "BP3D_femoral_artery_L" },
      { id: "brachial", name: "Brachial artery", detail: "The upper-arm artery where blood pressure is measured.", mesh: "BP3D_brachial_artery_L" },
    ],
    quiz: {
      question: "Which artery is the largest in the body?",
      options: ["Femoral artery", "Carotid artery", "Aorta", "Pulmonary artery"],
      answer: 2,
      explanation: "The aorta leaves the left ventricle and every other systemic artery branches from it.",
    },
  },
  {
    id: "veins",
    name: "Venous system",
    latin: "Systema venosum",
    system: "cardiovascular",
    model: bp3d("veins"),
    modelSource: "bp3d",
    tissue: "vessel",
    accent: "#5b6bb5",
    summary:
      "The whole-body tree of veins that returns blood to the heart at low pressure, joining into the superior and inferior venae cavae, plus the hepatic portal system that routes gut blood through the liver.",
    role: "Returns blood from the tissues to the heart and lungs.",
    modelScope: "Named veins of the BodyParts3D reference body, 404 parts. Venules and capillaries are not modelled.",
    facts: [
      { label: "Blood volume", value: "Veins hold about 60 percent of the blood at rest", sourceIds: ["openstax"], reviewStatus: "draft" },
      { label: "Valves", value: "Limb veins have one-way valves that stop blood pooling" },
      { label: "Great veins", value: "The superior and inferior venae cavae empty into the right atrium" },
      { label: "Exception", value: "The pulmonary veins carry oxygenated blood from the lungs" },
    ],
    functions: [
      "Collect deoxygenated blood from the capillaries",
      "Muscle contractions and valves push blood back up the legs",
      "The portal vein delivers absorbed nutrients to the liver first",
    ],
    terms: [
      { term: "Vena cava", meaning: "One of the two great veins that empty into the right atrium." },
      { term: "Jugular", meaning: "The neck veins that drain the head and brain." },
      { term: "Valve", meaning: "A one-way flap inside a vein that stops backflow." },
      { term: "Portal vein", meaning: "Carries blood from the intestines to the liver." },
      { term: "Femoral vein", meaning: "The main deep vein of the thigh." },
      { term: "Varicose", meaning: "A vein whose valves have failed, letting it swell." },
    ],
    hotspots: [
      { id: "ivc", name: "Inferior vena cava", detail: "Returns blood from the lower body to the right atrium.", mesh: "BP3D_Inferior_vena_cava" },
      { id: "jugular", name: "Internal jugular vein", detail: "Drains blood from the brain down the neck.", mesh: "BP3D_internal_jugular_vein_L" },
      { id: "portal", name: "Hepatic portal vein", detail: "Carries nutrient-rich blood from the gut into the liver.", mesh: "BP3D_Hepatic_portal_vein" },
      { id: "femoral", name: "Femoral vein", detail: "The deep vein of the thigh, alongside the femoral artery.", mesh: "BP3D_femoral_vein_L" },
      { id: "renal", name: "Renal vein", detail: "Returns filtered blood from the kidney.", mesh: "BP3D_renal_vein_L" },
    ],
    quiz: {
      question: "Why do leg veins have valves?",
      options: ["To speed up blood flow", "To stop blood flowing back down under gravity", "To filter the blood", "To raise blood pressure"],
      answer: 1,
      explanation: "Blood in the legs must climb against gravity; valves close between muscle squeezes so it cannot fall back.",
    },
  },
  {
    id: "brain",
  ...
  },
  {
    ...
    accent: "#d8b7a8",
    summary:
      "The entrance to the airway. Cartilage shapes the external nose, the septum divides the cavity in two, and the curled conchae on each side wall make air swirl so it is warmed, moistened, and cleaned before it reaches the lungs.",
    role: "Conditions and filters the air you breathe and houses the sense of smell.",
    modelScope: "Nasal cartilages, the septum (septal cartilage and vomer), the ethmoid, the nasal bones, and the inferior conchae from the BodyParts3D reference body. The lining and the olfactory nerves are not modelled.",
    facts: [
      { label: "Septum", value: "Cartilage in front and bone (vomer, ethmoid) behind", sourceIds: ["openstax"], reviewStatus: "draft" },
      { label: "Conchae", value: "Three curled shelves on each side wall that increase the surface area" },
      { label: "Lining", value: "Mucus and cilia trap dust and sweep it toward the throat" },
      { label: "Smell", value: "Olfactory receptors sit in the roof of the cavity" },
    ],
    functions: [
      "Warms and moistens incoming air",
      "Traps dust and microbes in mucus",
      "Detects odours through the olfactory receptors",
    ],
    terms: [
      { term: "Septum", meaning: "The wall that divides the nasal cavity into left and right halves." },
      { term: "Concha", meaning: "A curled shelf of bone inside the nose, also called a turbinate." },
      { term: "Vomer", meaning: "The thin bone forming the lower back part of the septum." },
      { term: "Ethmoid", meaning: "The spongy bone between the eyes that forms the roof and upper septum." },
      { term: "Cartilage", meaning: "Firm flexible tissue that shapes the tip and sides of the nose." },
      { term: "Olfactory", meaning: "Relating to the sense of smell." },
    ],
    hotspots: [
      { id: "septum", name: "Septal cartilage", detail: "The front part of the wall that divides the nose in two.", mesh: "BP3D_Septal_nasal_cartilage" },
      { id: "concha", name: "Inferior nasal concha", detail: "The largest of the curled shelves that swirl and warm the air.", mesh: "BP3D_inferior_nasal_concha_L" },
      { id: "vomer", name: "Vomer", detail: "The bony lower part of the septum.", mesh: "BP3D_Vomer" },
      { id: "nasal-bone", name: "Nasal bone", detail: "One of the pair of small bones forming the bridge of the nose.", mesh: "BP3D_nasal_bone_L" },
    ],
    quiz: {
      question: "What do the nasal conchae do?",
      options: ["Produce the voice", "Increase the surface that warms and moistens air", "Filter the blood", "Hold the teeth"],
      answer: 1,
      explanation: "Their curled shape makes air swirl over a large moist surface before it reaches the lungs.",
    },
  },
  {
    id: "larynx",
  ...
  },
  {
    ...
    latin: "Diaphragma",
    system: "respiratory",
    model: bp3d("diaphragm"),
    modelSource: "bp3d",
    tissue: "muscle",
    accent: "#c96a5a",
    summary:
      "The dome-shaped sheet of muscle that separates the chest from the abdomen. When it contracts it flattens, enlarging the chest so air is drawn into the lungs; when it relaxes it rises and air flows out.",
    role: "The main muscle of breathing.",
    modelScope: "The diaphragm alone, from the BodyParts3D reference body, with its openings for the oesophagus, aorta, and vena cava visible as gaps.",
    facts: [
      { label: "Shape", value: "A double dome, higher on the right over the liver", sourceIds: ["openstax"], reviewStatus: "draft" },
      { label: "Nerve", value: "The phrenic nerves from the neck (C3 to C5)" },
      { label: "Openings", value: "For the oesophagus, the aorta, and the inferior vena cava" },
      { label: "Rate", value: "About 12 to 20 contractions a minute at rest" },
    ],
    functions: [
      "Contracts and flattens to draw air in",
      "Relaxes and domes upward as air is pushed out",
      "Raises abdominal pressure for coughing, sneezing, and lifting",
    ],
    terms: [
      { term: "Inhalation", meaning: "Breathing in, when the diaphragm contracts." },
      { term: "Exhalation", meaning: "Breathing out, when the diaphragm relaxes." },
      { term: "Central tendon", meaning: "The flat tendinous top of the dome that the muscle fibres pull on." },
      { term: "Phrenic nerve", meaning: "The nerve that tells the diaphragm to contract." },
      { term: "Hiatus", meaning: "An opening in the diaphragm through which a tube or vessel passes." },
      { term: "Thoracic", meaning: "Relating to the chest." },
    ],
    hotspots: [
      { id: "dome", name: "Diaphragm", detail: "The muscular dome that drives breathing.", mesh: "BP3D_Diaphragm" },
      { id: "right", name: "Right dome", detail: "Sits higher because the liver lies beneath it.", position: [-0.45, 0.35, 0.1] },
      { id: "left", name: "Left dome", detail: "Sits slightly lower, above the stomach and spleen.", position: [0.45, 0.25, 0.1] },
    ],
    quiz: {
      question: "What happens to the diaphragm when you breathe in?",
      options: ["It relaxes and rises", "It contracts and flattens", "It moves sideways", "It stays still"],
      answer: 1,
      explanation: "Contracting flattens the dome, enlarging the chest so air pressure falls and air flows in.",
    },
  },
  {
    id: "mouth",
  ...
  {
    id: "oesophagus",
    name: "Oesophagus and pharynx",
    latin: "Oesophagus",
    system: "digestive",
    model: bp3d("oesophagus"),
    modelSource: "bp3d",
    tissue: "mucosa",
    accent: "#d4867a",
    summary:
      "The throat and the food pipe. The pharynx's constrictor muscles squeeze a swallowed bolus past the epiglottis into the oesophagus, a 25 cm muscular tube that carries it to the stomach by waves of peristalsis.",
    role: "Moves swallowed food from the mouth to the stomach.",
    modelScope: "The oesophagus, the three pairs of pharyngeal constrictors, and the epiglottis from the BodyParts3D reference body.",
    facts: [
      { label: "Length", value: "About 25 cm from the pharynx to the stomach", sourceIds: ["openstax"], reviewStatus: "draft" },
      { label: "Route", value: "Behind the trachea, through the diaphragm, to the cardia of the stomach" },
      { label: "Sphincters", value: "Upper and lower oesophageal sphincters at each end" },
      { label: "Transit", value: "A swallow takes about 8 to 10 seconds to reach the stomach" },
    ],
    functions: [
      "Pharyngeal constrictors push the bolus downward while the epiglottis covers the airway",
      "Peristaltic waves move food to the stomach even upside down",
      "The lower sphincter stops stomach acid flowing back up",
    ],
    terms: [
      { term: "Pharynx", meaning: "The throat, shared by the airway and the food route." },
      { term: "Constrictor", meaning: "A muscle that squeezes a tube; the pharynx has superior, middle, and inferior ones." },
      { term: "Epiglottis", meaning: "The flap that closes the airway during a swallow." },
      { term: "Bolus", meaning: "The ball of chewed food that is swallowed." },
      ...
      { term: "Reflux", meaning: "Stomach contents flowing back into the oesophagus." },
    ],
    hotspots: [
      { id: "oesophagus", name: "Oesophagus", detail: "The muscular food pipe running behind the trachea to the stomach.", mesh: "BP3D_Esophagus" },
      { id: "epiglottis", name: "Epiglottis", detail: "Tips backward to cover the larynx as you swallow.", mesh: "BP3D_Epiglottis" },
      { id: "superior", name: "Superior pharyngeal constrictor", detail: "The uppermost throat muscle, which starts the squeeze.", mesh: "BP3D_superior_pharyngeal_constrictor_L" },
      { id: "inferior", name: "Inferior pharyngeal constrictor", detail: "The lowest throat muscle, handing the bolus to the oesophagus.", mesh: "BP3D_inferior_pharyngeal_constrictor_L" },
    ],
    quiz: {
      question: "What moves food along the oesophagus?",
      options: ["Gravity alone", "Peristalsis", "Air pressure", "Cilia"],
      answer: 1,
      explanation: "Waves of muscle contraction push the bolus along, which is why you can swallow lying down.",
    },
  },
  {
    id: "stomach",
  ...
  },
  {
    ...
    system: "endocrine",
    model: bp3d("endocrine"),
    modelSource: "bp3d",
    tissue: "gland",
    accent: "#e2b563",
    summary:
      "Glands that release hormones straight into the blood: the pituitary and pineal glands at the base of the brain, and the adrenal glands perched on top of the kidneys. The pancreas and thyroid are covered in their own entries.",
    role: "Coordinates growth, metabolism, stress, and daily rhythms through hormones.",
    modelScope: "Pituitary gland, pineal body, and both adrenal glands from the BodyParts3D reference body, with the kidneys shown for position. The thyroid is not in the reference body.",
    facts: [
      { label: "Pituitary", value: "Pea-sized master gland controlling growth, thyroid, adrenals, and reproduction", sourceIds: ["openstax"], reviewStatus: "draft" },
      { label: "Adrenals", value: "Cortex makes cortisol and aldosterone; medulla makes adrenaline" },
      { label: "Pineal", value: "Makes melatonin, which sets the sleep cycle" },
      { label: "Signal", value: "Hormones travel in the blood to distant target cells" },
    ],
    functions: [
      "The pituitary releases growth hormone and controls other glands",
      "The adrenal glands raise heart rate and blood sugar under stress",
      "The pineal gland times sleep with light and dark",
    ],
    terms: [
      { term: "Hormone", meaning: "A chemical messenger released into the blood." },
      { term: "Endocrine", meaning: "Secreting directly into the blood rather than through a duct." },
      { term: "Pituitary", meaning: "The master gland hanging beneath the hypothalamus." },
      { term: "Adrenal", meaning: "Beside the kidney; the adrenal glands sit on top of each one." },
      { term: "Cortex and medulla", meaning: "The outer and inner parts of the adrenal gland, which make different hormones." },
      { term: "Adrenaline", meaning: "The fight-or-flight hormone from the adrenal medulla." },
      { term: "Melatonin", meaning: "The hormone from the pineal gland that makes you sleepy at night." },
    ],
    hotspots: [
      { id: "pituitary", name: "Pituitary gland", detail: "The master gland at the base of the brain.", mesh: "BP3D_Pituitary_gland" },
      { id: "pineal", name: "Pineal body", detail: "Deep in the brain, releasing melatonin at night.", mesh: "BP3D_Pineal_body" },
      { id: "adrenal", name: "Adrenal gland", detail: "Sits on the top of each kidney and makes adrenaline and cortisol.", mesh: "BP3D_adrenal_gland_L" },
      { id: "kidney", name: "Kidney", detail: "Shown for position; the adrenal gland caps it.", mesh: "BP3D_kidney_L" },
    ],
    quiz: {
      question: "Which gland releases adrenaline?",
      options: ["Pineal gland", "Pituitary gland", "Adrenal gland", "Thymus"],
      answer: 2,
      explanation: "The adrenal medulla releases adrenaline in response to stress.",
    },
  },
  {
    id: "small_intestine",
  ...
  },
  {
    ...
    system: "urinary",
    model: bp3d("urinary_system"),
    modelSource: "bp3d",
    tissue: "kidney",
    accent: "#d9a46c",
    summary:
      "The whole route of urine: two kidneys filter the blood, two ureters carry urine down to the bladder, which stores it until it leaves through the urethra.",
    role: "Removes waste and excess water while keeping the blood's salt balance.",
    modelScope: "Both kidneys, both ureters, the bladder, and the urethra from the BodyParts3D reference body. See the kidney entry for the internal structure.",
    facts: [
      { label: "Output", value: "About 1 to 2 litres of urine a day", sourceIds: ["openstax"], reviewStatus: "draft" },
      { label: "Filtered", value: "Roughly 180 litres of fluid pass through the kidneys daily; almost all is reabsorbed" },
      { label: "Ureters", value: "About 25 to 30 cm long, moving urine by peristalsis" },
      { label: "Urethra", value: "About 20 cm in males and 4 cm in females" },
    ],
    functions: [
      "Kidneys filter waste such as urea from the blood",
      "Ureters and bladder collect and store urine",
      "The urethra carries urine out under voluntary control",
    ],
    terms: [
      { term: "Urea", meaning: "The main nitrogen waste in urine, made in the liver from excess protein." },
      { term: "Ureter", meaning: "The tube from a kidney to the bladder." },
      { term: "Urethra", meaning: "The tube from the bladder to the outside." },
      { term: "Excretion", meaning: "Removing waste products of metabolism from the body." },
      { term: "Osmoregulation", meaning: "Keeping the water and salt balance of the blood steady." },
      { term: "Micturition", meaning: "The act of passing urine." },
    ],
    hotspots: [
      { id: "kidney", name: "Kidney", detail: "Filters the blood and forms urine.", mesh: "BP3D_kidney_R" },
      { id: "ureter", name: "Ureter", detail: "Carries urine from the kidney to the bladder in small peristaltic spurts.", mesh: "BP3D_ureter_L" },
      { id: "bladder", name: "Urinary bladder", detail: "Stretches to store urine until it is convenient to empty.", mesh: "BP3D_Urinary_bladder" },
      { id: "urethra", name: "Urethra", detail: "The final tube that carries urine out of the body.", mesh: "BP3D_Urethra" },
    ],
    quiz: {
      question: "In what order does urine travel?",
      options: ["Bladder, kidney, ureter, urethra", "Kidney, ureter, bladder, urethra", "Kidney, urethra, bladder, ureter", "Ureter, kidney, bladder, urethra"],
      answer: 1,
      explanation: "Urine forms in the kidneys, drains down the ureters, collects in the bladder, and leaves through the urethra.",
    },
  },
  {
    id: "kidney",
  ...
  },
  {
    ...
    accent: "#c39ac4",
    summary:
      "The internal male reproductive organs: the testes make sperm and testosterone, the epididymis stores and matures sperm, the deferent ducts carry it upward, and the seminal vesicles and prostate add the fluid that makes semen.",
    role: "Produces sperm and the male sex hormone testosterone.",
    modelScope: "Testes, epididymis, deferent ducts, seminal vesicles, and prostate from the BodyParts3D reference body. External anatomy is not included.",
    facts: [
      { label: "Testis", value: "About 4 to 5 cm long, held outside the body to stay a little cooler", sourceIds: ["openstax"], reviewStatus: "draft" },
      { label: "Sperm", value: "Made in the seminiferous tubules from puberty onward" },
      { label: "Epididymis", value: "A coiled tube about 6 m long if straightened" },
      { label: "Hormone", value: "Testosterone drives puberty and sperm production" },
    ],
    functions: [
      "Testes produce sperm and testosterone",
      "The epididymis stores sperm while they mature",
      "The deferent ducts carry sperm to the ejaculatory ducts inside the prostate",
    ],
    terms: [
      { term: "Testis", meaning: "The male gonad that makes sperm and testosterone; plural testes." },
      { term: "Epididymis", meaning: "The coiled tube on the back of each testis where sperm mature." },
      { term: "Deferent duct", meaning: "The vas deferens, the muscular tube carrying sperm toward the urethra." },
      { term: "Seminal vesicle", meaning: "A gland that adds sugar-rich fluid to semen." },
      { term: "Gonad", meaning: "An organ that makes sex cells: the testis or the ovary." },
      { term: "Testosterone", meaning: "The main male sex hormone." },
      { term: "Gamete", meaning: "A sex cell, such as a sperm or an egg." },
    ],
    hotspots: [
      { id: "testis", name: "Testis", detail: "Makes sperm and testosterone.", mesh: "BP3D_testis_L" },
      { id: "epididymis", name: "Epididymis", detail: "The coiled tube where sperm are stored and mature.", mesh: "BP3D_epididymis_L" },
      { id: "duct", name: "Deferent duct", detail: "Carries sperm up from the epididymis into the pelvis.", mesh: "BP3D_deferent_duct_L" },
      { id: "vesicle", name: "Seminal vesicle", detail: "Adds the fluid that feeds sperm.", mesh: "BP3D_seminal_vesicle_L" },
      { id: "prostate", name: "Prostate", detail: "Adds a milky fluid and surrounds the urethra below the bladder.", mesh: "BP3D_Prostate" },
    ],
    quiz: {
      question: "Where are sperm produced?",
      options: ["Prostate", "Epididymis", "Testes", "Seminal vesicles"],
      answer: 2,
      explanation: "Sperm are made in the seminiferous tubules of the testes, then stored in the epididymis.",
    },
  },
  {
    id: "muscles",
    ...
    accent: "#c4433f",
    summary:
      "The skeletal muscles of the whole body, nearly 400 named parts from the muscles of the face and throat to the small muscles of the hands and feet. Each pulls on bones across a joint to produce movement and posture.",
    role: "Moves the body, holds it upright, and generates heat.",
    modelScope: "Skeletal muscles of the BodyParts3D reference body. Smooth muscle of the organs and the heart's own muscle are not included.",
    facts: [
      { label: "Count", value: "About 600 skeletal muscles making up 40 percent of body weight", sourceIds: ["openstax"], reviewStatus: "draft" },
      { label: "Largest", value: "Gluteus maximus; the longest is the sartorius" },
      { label: "Pairs", value: "Muscles work in antagonistic pairs, such as biceps and triceps" },
      { label: "Attachment", value: "Tendons join muscle to bone" },
    ],
    functions: [
      "Contract to pull on bones and produce movement",
      "Hold posture against gravity and stabilise joints",
      "Shivering and everyday contraction generate body heat",
    ],
    terms: [
      { term: "Skeletal muscle", meaning: "Striped muscle attached to bones and under voluntary control." },
      { term: "Tendon", meaning: "The tough cord that connects a muscle to a bone." },
      { term: "Antagonistic pair", meaning: "Two muscles that pull in opposite directions across a joint." },
      { term: "Flexor", meaning: "A muscle that bends a joint." },
      { term: "Extensor", meaning: "A muscle that straightens a joint." },
      { term: "Origin and insertion", meaning: "The fixed and the moving attachment points of a muscle." },
      { term: "Deltoid", meaning: "The shoulder muscle that raises the arm." },
      { term: "Quadriceps", meaning: "The four-part muscle at the front of the thigh that straightens the knee." },
      { term: "Hamstrings", meaning: "The muscles at the back of the thigh that bend the knee." },
    ],
    hotspots: [
      { id: "deltoid", name: "Deltoid", detail: "Caps the shoulder and lifts the arm sideways.", mesh: "BP3D_Acromial_part_of_left_deltoid" },
      { id: "pectoralis", name: "Pectoralis major", detail: "The chest muscle that pulls the arm forward and across.", mesh: "BP3D_Sternocostal_part_of_left_pectoralis_major" },
      { id: "biceps", name: "Biceps brachii", detail: "Bends the elbow and turns the palm up.", mesh: "BP3D_Long_head_of_left_biceps_brachii" },
      { id: "abdominals", name: "External oblique", detail: "Flat abdominal muscle that bends and twists the trunk.", mesh: "BP3D_external_oblique_L" },
      { id: "gluteus", name: "Gluteus maximus", detail: "The largest muscle, extending the hip for climbing and standing up.", mesh: "BP3D_gluteus_maximus_L" },
      { id: "quadriceps", name: "Rectus femoris", detail: "Part of the quadriceps at the front of the thigh, straightening the knee.", mesh: "BP3D_rectus_femoris_L" },
      { id: "calf", name: "Gastrocnemius", detail: "The calf muscle that points the foot and pushes off in walking.", mesh: "BP3D_Medial_head_of_left_gastrocnemius" },
    ],
    quiz: {
      question: "The biceps and triceps are an example of what?",
      options: ["A tendon", "An antagonistic pair", "A joint", "A ligament"],
      answer: 1,
      explanation: "The biceps bends the elbow while the triceps straightens it; each relaxes as the other contracts.",
    },
  },
  {
    id: "skeleton",
...
export const anatomySources = [
  ...
  },
  {
    ...
    detail: `Source of the ${bp3dModelCount} whole-body models (stomach, oesophagus, skeleton, muscles, arteries, veins, and more). Published by the Database Center for Life Science under CC BY 4.0 and shared with the Human Atlas body tab.`,
